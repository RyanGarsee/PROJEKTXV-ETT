...
return Def.StepsDisplayList {
	...
	CursorP1 = Def.ActorFrame {
		...
		OnCommand=function(self)
			self:addx(58):addy(9):diffuse(color(".2,.55,1,1"))
		end;
		HideCommand=function(self)
			self:diffuse(color("0,0,0,1")):linear(.1):zoomy(0)
		end;
		ShowCommand=function(self)
			self:diffuse(color(".2,.55,1,1")):linear(.1):zoomy(1)
		end;
	...
	CursorP2 = Def.ActorFrame {
		...
		OnCommand=function(self)
			self:addx(58):addy(9):diffuse(color(".98,.55,.1,1"))
		end;
		HideCommand=function(self)
			self:diffuse(color("0,0,0,1")):linear(.1):zoomy(0)
		end;
		ShowCommand=function(self)
			self:diffuse(color(".98,.55,.1,1")):linear(.1):zoomy(1)
		end;
		ChangeCommand=function(self)
			self:stoptweening():linear(0)
		end;
